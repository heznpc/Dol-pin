...
현행 요구사항과 미해결 결함은 [TODO](TODO.md)에서 추적합니다.
[2026-09-18 설계 재검토](docs/design-review-2026-09-18.md)는 코드 기준의 판단이며,
과거 실행 기록이나 아래 구현 목록이 모든 요구사항의 충족을 뜻하지 않습니다.
...
| 소비자 웹 | Next.js: 동일 backend의 소셜·전화 인증, 탐색·등록·상세. 이메일 가입·로그인 UI는 미구현 |
