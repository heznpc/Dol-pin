...
const result=spawnSync('deno',['test','--allow-env','--allow-net','--allow-run=docker','scripts/qa/finance_test.ts','scripts/qa/backend_ops_test.ts'],{stdio:'inherit',env:{...process.env,SUPABASE_URL:status.API_URL,SUPABASE_ANON_KEY:status.ANON_KEY,SUPABASE_SERVICE_ROLE_KEY:status.SERVICE_ROLE_KEY,DOLPIN_WEB_URL:'http://127.0.0.1:3010'}});
